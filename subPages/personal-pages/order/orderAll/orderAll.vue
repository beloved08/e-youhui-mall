<template>
	<view class="container">
		<view v-if="allOrder.length > 0">
			<view v-for="(item,index) in allOrder" :key="index" class="order-content-for">
						...
						<view class="order-all-box">
							...
							<view class="order-bottom">
								<tui-button @click="seeOrderDetail(item)" plain size="25" shape="circle" width="160rpx"
									height="50rpx" type="green">查看详情</tui-button>
							</view>
						</view>
					</template>
		...
		<view v-else class="empty">
			<view class="empty-image">
				<image style="width: 100%;height: 100%;"
					src="https://eyouhui.oss-cn-hangzhou.aliyuncs.com/wx/order/1.png" mode=""></image>
			</view>
